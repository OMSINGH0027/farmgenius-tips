...
export const FarmMapSection = () => {
  ...
  const [farmLocation, setFarmLocation] = useState<MarkerPosition>({ lat: 20.5937, lng: 78.9629 });
  ...
  const handleSetLocation = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    const form = e.currentTarget;
    const formElements = form.elements as HTMLFormControlsCollection;
    const latitudeInput = formElements.namedItem('latitude') as HTMLInputElement;
    const longitudeInput = formElements.namedItem('longitude') as HTMLInputElement;
